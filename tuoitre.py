...
def crawl_data(page,channel_id):
    try:
        ...
        headers = {
            ...
            'accept':'*/*',
            'x-csrf-token':'kBDy96zCFtX2CtwAqQOGMDcPFA4mGELGy-TksI5uDiTkWJzPyfVztrlbskLGYu9HBT1bRXcpBPaAjKvYuC09SA==',
            'sec-ch-ua-mobile':'?0',
