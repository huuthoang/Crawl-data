...
def crawl_data(page,channel_id):
    try:
        url = "https://tuoitrenews.vn/page?slug=ttn-business&ajax=13---ttnews_custom_list&page_number="+str(page)
        headers = {
            'authority':'tuoitrenews.vn',
            'sec-ch-ua' : '" Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"',
            'accept':'*/*',
            'x-csrf-token':'ZowYXp_2F6ZfPLe1WfwgUEdNRaYXcj9hWYe_IlxNjrAtyCoQrJhe7wVy9IwbxUYELSs99kAQUAQK0YhMNzrs3A==',
            'sec-ch-ua-mobile':'?0',
