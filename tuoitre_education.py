...
def crawl_data(page,channel_id):
    try:
        url = "https://tuoitrenews.vn/page?slug=ttn-education&ajax=13---ttnews_custom_list&page_number="+str(page)
        headers = {
            'authority':'tuoitrenews.vn',
            'sec-ch-ua' : '" Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"',
            'accept':'*/*',
            'x-csrf-token':'zMN6w3y3dXQsPIevHn_DTntTz1RLrqBBR7pgIjvY02-W8hS1BNkwTBsI38h0M5cWHji6Y3yZ9hcRzjFHc5ubNQ==',
            'sec-ch-ua-mobile':'?0',
            ...
            'cookie':'_uidcms=162485369825987510; _ga=GA1.2.1238474114.1624853699; __RC=5; __R=3; __gads=ID=3ed3e093827f415c:T=1624853700:S=ALNI_MY7Se-LfyI2E2k4fWCwWXN0hSAmTQ; __tb=0; fg_version=3; fg_uuid=0f8975a6d023e0a6114b20b196d85618; __UF=2%2C5; fg_lastUpdate=1625210811094; _gid=GA1.2.935057992.1625453099; __IP=1953376312; fg_lastModify=1625538942726; fg_guid=8660848272112614305; _gat_UA-9712051-40=1; __uif=__uid%3A1860848272112614305%7C__ui%3A2%252C5%7C__create%3A1616084827'
            }
